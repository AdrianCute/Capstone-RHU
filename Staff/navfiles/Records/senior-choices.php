		...
		<ul class="side-menu">
			...
			<li>
				...
				<ul class="side-dropdown show">
					...
					<li><a href="senior-choices.php" class="active-now active">Senior Citizen Master Listing</a></li>
		...
		<main>
			...
			<div class="data">
				<div class="content-data">
					<div class="head">
						<h3>Senior Citizen Master Listing Data</h3>
						<div class="menu">
					...
					<div class="table-wrapper">
						<table  id="myTable" class="emp-table">
							...
							<tr>
									<td>Adiangao</td>
									<td>
									<form action="Senior/Senior.php" method="post">
