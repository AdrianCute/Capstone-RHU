...
<div class="modal fade" id="logoutmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li>
				<a href="#" class="active"><i class='bx bxs-inbox icon' ></i> Barangay Records <i class='bx bx-chevron-right icon-right' ></i></a>
				<ul class="side-dropdown show">
					...
					<li><a href="Immunization-choices.php" class="active-now active">Immunization</a></li>
						...
						<table  id="myTable" class="emp-table">
							...
							<tbody>
								<tr>
									<td>Adiangao</td>
									<td>
										<form action="Immunization/Immunization.php" method="post">
								...
								<tr>
									...
									<td>
										<form action="Immunization/Immunization.php" method="post">
											<button type="submit" name="address" 
										value="San Vecinte" class="btnnn">View</button>
									</form></td>
										<td>Active</td>
								</tr>
								<tr>
									...
									<td>
										<form action="Immunization/Immunization.php" method="post">
											<button type="submit" name="address" 
										value="Sta Cruz" class="btnnn">View</button>
									</form></td>
										<td>Active</td>
								</tr>
								<tr>
