...
<div class="profiling-input-field">
    ...
    <input type="text" name="water" placeholder="Enter type of Water Source" disabled>
</div>
...
<div class="profiling-input-field">
    <label for="water_source">Type of Water Source</label>
    <input type="text" id="water" name="water" placeholder="Enter type of Water Source">
</div>
        ...
        <li><a href="../../../index.php" class="active"><i class='bx bxs-dashboard icon' ></i> Dashboard</a></li>
			...
			<li>
				...
				<ul class="side-dropdown show">
					<li ><a href="profiling-all.php" class="active-now">Profiling</a></li>
...
<div class="profiling-fields">
       <div class="profiling-input-field">
        <label> Date of Visit<span class="red">*</span></label>
        <input type="date" name="visit" placeholder="DD/MM/YY" >
    </div>
<div class="profiling-input-field">
    ...
    <div class="profiling-input-field">
        ...
        <input type="text" name="water" placeholder="Enter type of Water Source" >
    </div>
