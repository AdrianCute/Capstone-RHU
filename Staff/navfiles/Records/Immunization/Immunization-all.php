            ...
            <div class="profiling-form first">
                <div class="profiling-details personal">
					...
					<div class="profiling-input-field">
						...
						<div class="profiling-input-field">
                            <label>Fathers Name</label>
                            <input oninput="capitalizeFirstLetter(this)" type="Text" id="father" name="father" placeholder="Enter Fathers Name" >
                        </div>
                        ...
                        <div class="profiling-input-field">
                            ...
                            <div class="profiling-input-field">
                                <label>Family Number</label>
                                <input type="text" id="number" name="number" placeholder="Enter Barangay" >
                            </div>
                            <div class="profiling-input-field">
                                <label>At Birth Dose</label>
...
<script>
    ...
    <div class="profiling-input-field">
     ...
     <input oninput="capitalizeFirstLetter(this)" type="Text" id="" name="mname" placeholder="Enter Middlename">
						...
						<div class="profiling-input-field">
                            ...
                            <input oninput="capitalizeFirstLetter(this)" type="Text" name="father" placeholder="Enter Fathers Name" >
                        </div>
    ...
    <input type="text" name="number" id="familyNumber" placeholder="Enter Barangay" >
</div>
