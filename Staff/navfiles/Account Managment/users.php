...
<div class="modal fade" id="user_update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="container-box">
                      ...
                      <div class="content">
                        <form action="update_data/update_user.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="rejectmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_data/reject_user.php" method="POST">
...
<div class="modal fade" id="logoutmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<div class="modal fade" id="approvemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_data/approve.php" method="POST">
		...
		<li><a href="../../index.php" class="active"><i class='bx bxs-dashboard icon' ></i> Dashboard</a></li>
			...
			<li>
				...
				<ul class="side-dropdown show">
					<li><a href="users.php"  class="active-now">Patient Accounts</a></li>
	...
	$sql = "SELECT * FROM `users` WHERE UserType='User' AND Status='Approve'";
    $result = mysqli_query($conn, $sql);
    $hasDataApprove = mysqli_num_rows($result) > 0;

    // Check if there is data for the second container
    $sql = "SELECT * FROM `users` WHERE UserType='User' AND Status='Pending'";
    $result = mysqli_query($conn, $sql);
...
WHERE UserType='User' AND Status='Approve'";
						$result = mysqli_query($conn, $sql);
								while ($row = mysqli_fetch_assoc($result)) {
								  ...
								  <td><?php echo $row["birthdate"] ?></td>
									...
									<td>
    <img class="enlarge-image" src="../../../user/files/uploaded_img/<?php echo $row["Profile"] ?>" alt="Person Image" data-image-url="../../../user/files/uploaded_img/<?php echo $row["Profile"] ?>">
</td>	
								    <td>
...
LEFT JOIN personal_information pi ON ui.Record_ID = pi.Record_ID
LEFT JOIN address_information ai ON ui.Record_ID = ai.Record_ID
WHERE UserType='User' AND Status='Pending'";
...
$result = mysqli_query($conn, $sql);
								while ($row = mysqli_fetch_assoc($result)) {
								  ...
								  <td><?php echo $row["birthdate"] ?></td>
								    ...
								    <td><?php echo $row["contact_num"] ?></td>
									<td>
    <img class="enlarge-image" src="../../../register/uploaded_img/<?php echo $row["Person_ID"] ?>" alt="Person Image" data-image-url="../../../register/uploaded_img/<?php echo $row["Person_ID"] ?>">
</td>								    <td>
