...
<div class="modal fade" id="user_update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="container-box">
                      ...
                      <div class="content">
                        <form action="update_data/update_dental.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="rejectmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_data/reject_dental.php" method="POST">
	...
	<div class="modal fade" id="approvemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_data/approve_dental.php" method="POST">
		...
		<li><a href="../../index.php" class="active"><i class='bx bxs-dashboard icon' ></i> Dashboard</a></li>
			...
			<li>
				...
				<ul class="side-dropdown show">
					...
					<li><a href="Dental-Accounts.php" class="active-now">Dental Accounts</a></li>
...
<script>
					...
					<div class="table-wrapper">
						<table  id="myTable" class="emp-table">
							...
							<tbody>
								...
								WHERE u.UserType='Dental' AND Status='Approve'";
								...
								while ($row = mysqli_fetch_assoc($result)) {
								  ...
								  <td><?php echo $row["birthdate"] ?></td>
									...
									<td>
    <img class="enlarge-image" src="../../../dental/Account/uploaded_img/<?php echo $row["Profile"] ?>" alt="Person Image" data-image-url="../../../dental/Account/uploaded_img/<?php echo $row["Profile"] ?>">
</td>		
	...
	LEFT JOIN personal_information pi ON ui.Record_ID = pi.Record_ID
	LEFT JOIN address_information ai ON ui.Record_ID = ai.Record_ID
	WHERE u.UserType='Dental' AND Status='Pending'";								
$result = mysqli_query($conn, $sql);
								while ($row = mysqli_fetch_assoc($result)) {
									?>
								  <tr>
