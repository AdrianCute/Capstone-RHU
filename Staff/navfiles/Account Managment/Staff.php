...
<div class="modal fade" id="user_update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="container-box">
                      ...
                      <div class="content">
                        <form action="update_data/update_staff.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="rejectmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_data/Reject-Staff.php" method="POST">
...
<div class="modal fade" id="logoutmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<div class="modal fade" id="approvemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_data/approve-staff.php" method="POST">

                    <div class="feedback-content">

                        <input type="hidden" name="approve_id" id="approve_id">
						<span class="feedback-title">Approve Account?</span>
                		<p class="feedback-message">Are you sure you want to Approve this Account?</p>
                    </div>
               <div class="profiling-action">
		...
		<ul class="side-menu">
			...
			<li>
				...
				<ul class="side-dropdown show">
					...
					<li><a href="Staff.php" class="active-now">Staff Accounts</a></li>
	...
	$sql = "SELECT * FROM `users` WHERE UserType='Staff' AND Status='Approve'";
    $result = mysqli_query($conn, $sql);
    $hasDataApprove = mysqli_num_rows($result) > 0;

    // Check if there is data for the second container
    $sql = "SELECT * FROM `users` WHERE UserType='Staff' AND Status='Pending'";
    $result = mysqli_query($conn, $sql);
...
WHERE UserType='Staff' AND Status='Approve'";
						$result = mysqli_query($conn, $sql);
								while ($row = mysqli_fetch_assoc($result)) {
								  ...
								  <td><?php echo $row["birthdate"] ?></td>
									...
									<td>
    <img class="enlarge-image" src="../../../Staff/navfiles/Account Managment/uploaded_img/<?php echo $row["Profile"] ?>" alt="Person Image" data-image-url="../../../user/files/uploaded_img/<?php echo $row["Profile"] ?>">
</td>	
								    <td>
									 <button class="btnn updateaccount" type="button">Update</button>
    ...
    <?php if ($hasDataPending) { ?>
		...
		<div class="content-data">
					<div class="head">
						<h3>Requested Patient Account</h3>
						<div class="menu">
...
LEFT JOIN personal_information pi ON ui.Record_ID = pi.Record_ID
LEFT JOIN address_information ai ON ui.Record_ID = ai.Record_ID
WHERE UserType='Staff' AND Status='Pending'";
...
$result = mysqli_query($conn, $sql);
								while ($row = mysqli_fetch_assoc($result)) {
								  ...
								  <td><?php echo $row["birthdate"] ?></td>
								    ...
								    <td><?php echo $row["contact_num"] ?></td>
									<td>
    <img class="enlarge-image" src="../../../Staff/navfiles/Account Managment/uploaded_img/<?php echo $row["Profile"] ?>" alt="Person Image" data-image-url="../../../register/uploaded_img/<?php echo $row["Profile"] ?>">
</td>								    <td>
									<button class="btnn approve" type="button">Approve</button>
