...
if ($result1 && $result3 && $result5) {
    ...
    header("Location: ../Barangay-accounts.php?success=Information has been Updated");
    exit();
} else {
    header("Location: ../Barangay-accounts.php?error=unknown error occurred&$user_data");
    exit();
}    
      }
