...
if ($result1 && $result3 && $result5) {
    ...
    header("Location: ../Dental-Accounts.php?success=Information has been Updated");
    exit();
} else {
    header("Location: ../Dental-Accounts.php?error=unknown error occurred&$user_data");
    exit();
}    
      }
    ...
    header("Location: ../Dental-Accounts.php");
    exit();
}
?>
