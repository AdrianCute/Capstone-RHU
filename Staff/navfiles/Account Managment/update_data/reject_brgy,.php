    ...
    if ($result) {
        ...
        try {
            ...
            $message = $client->messages->create(
                ...
                [
                    'from' => '+12512702652', 
                    'body' => 'Sorry, Your account has been Rejected due to you are not a Cetizen of San Jose.'
                ]
            );

            header("Location: ../Barangay-accounts.php?success=Account Rejected Successfully");
        } catch (Exception $e) {
            // Handle any errors that occur during SMS sending
            header("Location: ../Barangay-accounts.php?error=Error sending SMS: " . $e->getMessage());
        }
    }
}
?>
