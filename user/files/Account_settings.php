...
<div class="modal fade" id="logoutmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="personal_record.php" c><i class='bx bxs-receipt icon' ></i> Personal Record</a></li>

			<li><a href="Profile.php"><i class='bx bxs-user icon' ></i> Profile</a></li>
			<li><a href="Account_settings.php" class="active"><i class='bx bx-cog icon' ></i> Account Settings</a></li>
     	           ...
     	           <?php } ?>
									  <div class="user-details">
										<div class="input-boxes">
										  ...
										  <input type="password" name="current" placeholder="Enter the current Password" required>
										</div>
										<div class="input-boxes">
