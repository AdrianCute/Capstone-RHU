...
<div class="modal fade" id="logoutmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<section id="sidebar">
		...
		<li><a href="../index.php" ><i class='bx bxs-dashboard icon' ></i> Dashboard</a></li>
			...
			<li><a href="Appointment.php" class="active"><i class='bx bxs-calendar icon' ></i> Set Appointment</a></li>
      ...
      <form action="php/appointment.php" method="POST" class="form">
        ...
        <div class="column">
          <div class="input-box">
            ...
            <input type="text" name="number" value="<?php echo  $_SESSION['Contact_num'] ?>" placeholder="" required />
          </div>
          <div class="input-box">
            <label>Birth Date<span class="red">*</span></label>
            <input type="date" name="birthday" value="<?php echo  $_SESSION['bday'] ?>" placeholder="Enter birth date" required />
          </div>
		  
		  
        </div>
        <div class="input-box">
          <label>Service you will Acquire<span class="red">*</span>:</label>
