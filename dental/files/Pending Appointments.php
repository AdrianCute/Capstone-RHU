...
<div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
			<div class="profiling-container-try">
			<header>View Data Form</header>
        ...
        <div class="input-box">
          ...
          <input type="text" name="Fname" id="name"  required disabled />
         </div>
		 <div class="input-box">
          <label>Address:</label>
		 ...
		 <div class="input-box">
          ...
          <input type="text" name="number" id="contact"  required disabled/>
         </div>
		 </div>
		 ...
		 <div class="input-box">
          ...
          <input type="text" name="address" id="date"  required disabled/>
         </div>
          <div class="input-box">
            <label>Age: </label>
            <input type="text" name="number" id="age" placeholder="" required disabled/>
          </div>
          <div class="input-box">
            <label>Birthday:</label>
            <input type="date" name="birthday" id="bday"  placeholder="Enter birth date" required disabled/>
          </div>
		  </div>
		  <div class="column">
          <div class="input-box">
            <label>Service Acquiring: </label>
            <input type="text" name="number" id="service" placeholder="" required disabled/>
          </div>
		  <div class="input-box">
            <label>Appoinment Date: </label>
            <input type="date" name="number" id="appointment"  placeholder="" required disabled/>
          </div>
          <div class="input-box">
            <label>Status:</label>
            <input type="text" name="birthday" id="status"  style="color: red;" placeholder="Enter birth date" required disabled/>
          </div>
            ...
            <div class="modal-content">
                ...
                <form action="../Account/update_data/delete_approve.php" method="POST">
					...
					<div class="profiling-action">
                        <button type="submit" name="deletedata" class="de,l">Delete</button>
	...
	<a href="#" class="brand"><img src="../../images/LOGO.png" alt="" class='bx icon'> RHU</a>
		<ul class="side-menu">
			...
			<li>
				<a href="Pending Appointments.php" class="active"><i class='bx bxs-receipt icon' ></i> Pending Appointments </a>
			</li>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<h1 class="title">Pending Appointments</h1>
			<div class="data">
...
<script>
    ...
    closeSuccessBtn.addEventListener('click', () => {
        ...
        window.location.reload();
					...
					<div class="reg">
					<button class="gen export" type="button"> Generate Report</button>
						...
						<thead>
							...
							GROUP BY a.Appointment_ID";
								...
								while ($row = mysqli_fetch_assoc($result)) {
								  ...
								  <td><a class="butones viewbtn"><?php echo $row["LName"].', '.$row["FName"].', '.$row["MName"] ?></a></td>
								  <td><?php echo $row["Barangay"] ?></td>
								    ...
								    <td>
									<button type="button" class="btnn editbtn"> Remark </button>
