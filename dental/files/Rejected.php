...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<div class="modal fade" id="exportmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="../Account/update_data/export_reject.php" method="POST">
	...
	<a href="#" class="brand"><img src="../../images/LOGO.png" alt="" class='bx icon'> RHU</a>
		<ul class="side-menu">
			...
			<li><a href="Rejected.php" class="active" ><i class='bx bxs-receipt icon' ></i> Rejected Appointments</a></li>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<h1 class="title">Rejected Appointment</h1>
			<div class="data">
